...
| <a name="input_authorizer_lambda_invoke_arn"></a> [authorizer\_lambda\_invoke\_arn](#input\_authorizer\_lambda\_invoke\_arn) | Invoke ARN of the Lambda function used by the authorizer. | `string` | `null` | no |
