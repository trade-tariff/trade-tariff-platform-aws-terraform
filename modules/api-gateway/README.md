...
| [aws_api_gateway_gateway_response.throttled](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_gateway_response) | resource |
...
| [aws_api_gateway_integration.uk](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_integration) | resource |
...
| [aws_api_gateway_integration.uk_fallback_proxy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_integration) | resource |
...
| [aws_api_gateway_integration.xi](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_integration) | resource |
...
| [aws_api_gateway_integration.xi_fallback_proxy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_integration) | resource |
...
| [aws_api_gateway_method.uk](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_method) | resource |
...
| [aws_api_gateway_method.uk_fallback_proxy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_method) | resource |
...
| [aws_api_gateway_method.xi](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_method) | resource |
...
| [aws_api_gateway_method.xi_fallback_proxy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_method) | resource |
...
| [aws_api_gateway_resource.uk_fallback_proxy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_resource) | resource |
...
| [aws_api_gateway_resource.xi_fallback_proxy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_resource) | resource |
...
| <a name="input_cache_key_params"></a> [cache\_key\_params](#input\_cache\_key\_params) | List of query string parameters to include in the cache key. | `list(string)` | <pre>[<br/>  "as_of",<br/>  "country_code",<br/>  "heading_code",<br/>  "include",<br/>  "limit",<br/>  "page",<br/>  "per_page",<br/>  "type",<br/>  "code",<br/>  "description",<br/>  "order_number",<br/>  "year",<br/>  "month",<br/>  "day",<br/>  "name",<br/>  "cas",<br/>  "source",<br/>  "excluded",<br/>  "q",<br/>  "query.letter",<br/>  "filter.cas_rn",<br/>  "filter.cus",<br/>  "filter.exclude_none",<br/>  "filter.from_date",<br/>  "filter.geographical_area_id",<br/>  "filter.goods_nomenclature_item_id",<br/>  "filter.goods_nomenclature_sid",<br/>  "filter.has_article",<br/>  "filter.meursing_additional_code_id",<br/>  "filter.simplified_procedural_code",<br/>  "filter.status",<br/>  "filter.to_date",<br/>  "filter.type"<br/>]</pre> | no |
...
| <a name="input_uk_uncached_paths"></a> [uk\_uncached\_paths](#input\_uk\_uncached\_paths) | List of API paths that should not be cached on the UK service. | `set(string)` | <pre>[<br/>  "chemical_substances",<br/>  "description_intercepts",<br/>  "exchange_rates",<br/>  "healthcheck",<br/>  "live_issues",<br/>  "news",<br/>  "search",<br/>  "search_suggestions",<br/>  "search_references"<br/>]</pre> | no |
...
| <a name="input_xi_uncached_paths"></a> [xi\_uncached\_paths](#input\_xi\_uncached\_paths) | List of API paths that should not be cached on the XI service. | `set(string)` | <pre>[<br/>  "chemical_substances",<br/>  "description_intercepts",<br/>  "green_lanes",<br/>  "healthcheck",<br/>  "search",<br/>  "search_suggestions",<br/>  "search_references"<br/>]</pre> | no |
