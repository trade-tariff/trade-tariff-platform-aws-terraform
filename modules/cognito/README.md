...
| <a name="input_client_token_validity"></a> [client\_token\_validity](#input\_client\_token\_validity) | Client token validity settings. Units can be 'seconds', 'minutes', 'hours', or 'days'. Default to 1 hour for all tokens. | <pre>object({<br/>    access_token = optional(<br/>      object({<br/>        length = optional(number, 1)<br/>        units  = optional(string, "hours")<br/>      }),<br/>      {<br/>        length = 1<br/>        units  = "hours"<br/>      }<br/>    )<br/>    id_token = optional(<br/>      object({<br/>        length = optional(number, 1)<br/>        units  = optional(string, "hours")<br/>      }),<br/>      {<br/>        length = 1<br/>        units  = "hours"<br/>      }<br/>    )<br/>    refresh_token = optional(<br/>      object({<br/>        length = optional(number, 1)<br/>        units  = optional(string, "hours")<br/>      }),<br/>      {<br/>        length = 1<br/>        units  = "hours"<br/>      }<br/>    )<br/>  })</pre> | <pre>{<br/>  "access_token": {<br/>    "length": 1,<br/>    "units": "hours"<br/>  },<br/>  "id_token": {<br/>    "length": 1,<br/>    "units": "hours"<br/>  },<br/>  "refresh_token": {<br/>    "length": 1,<br/>    "units": "hours"<br/>  }<br/>}</pre> | no |
