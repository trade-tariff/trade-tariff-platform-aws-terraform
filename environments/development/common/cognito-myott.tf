...
import {
  to = module.myott_cognito.aws_cognito_user_pool.this
  id = "eu-west-2_7nfDcXWtm"
}

import {
  to = module.myott_cognito.aws_cognito_user_pool_client.this[0]
  id = "eu-west-2_7nfDcXWtm/69k5qru5ikpfmttisinubmjt34"
}
