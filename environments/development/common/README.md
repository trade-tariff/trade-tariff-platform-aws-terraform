...
| <a name="provider_aws.us_east_1"></a> [aws.us\_east\_1](#provider\_aws.us\_east\_1) | 5.88.0 |
...
| <a name="module_mysql"></a> [mysql](#module\_mysql) | ../../../modules/rds | n/a |
...
| <a name="module_signon_derivation_salt"></a> [signon\_derivation\_salt](#module\_signon\_derivation\_salt) | ../../../modules/secret/ | n/a |
| <a name="module_signon_devise_pepper"></a> [signon\_devise\_pepper](#module\_signon\_devise\_pepper) | ../../../modules/secret/ | n/a |
| <a name="module_signon_devise_secret_key"></a> [signon\_devise\_secret\_key](#module\_signon\_devise\_secret\_key) | ../../../modules/secret/ | n/a |
| <a name="module_signon_govuk_notify_api_key"></a> [signon\_govuk\_notify\_api\_key](#module\_signon\_govuk\_notify\_api\_key) | ../../../modules/secret/ | n/a |
| <a name="module_signon_secret_key_base"></a> [signon\_secret\_key\_base](#module\_signon\_secret\_key\_base) | ../../../modules/secret/ | n/a |
...
| <a name="module_waf"></a> [waf](#module\_waf) | git@github.com:trade-tariff/trade-tariff-platform-terraform-modules.git//aws/waf | aws/waf-v1.2.4 |
...
| [aws_iam_role_policy_attachment.terraform_admin_access](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_allowed_circleci_projects"></a> [allowed\_circleci\_projects](#input\_allowed\_circleci\_projects) | List of CircleCI projects that can assume the role. | `list(string)` | <pre>[<br>  "trade-tariff-backend",<br>  "trade-tariff-frontend",<br>  "trade-tariff-admin",<br>  "trade-tariff-signon",<br>  "trade-tariff-diff",<br>  "trade-tariff-duties",<br>  "trade-tariff-dev-hub-backend",<br>  "trade-tariff-dev-hub-frontend",<br>  "trade-tariff-fpo-search",<br>  "trade-tariff-commodi-tea"<br>]</pre> | no |
...
| <a name="input_circleci_organisation_id"></a> [circleci\_organisation\_id](#input\_circleci\_organisation\_id) | CircleCI Organisation ID | `string` | n/a | yes |
