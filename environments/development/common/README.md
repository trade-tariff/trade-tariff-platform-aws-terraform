...
| <a name="input_thumbprint_list"></a> [thumbprint\_list](#input\_thumbprint\_list) | List of thumbprints for the OIDC provider. | `list(string)` | <pre>[<br>  "06B25927C42A721631C1EFD9431E648FA62E1E39"<br>]</pre> | no |
