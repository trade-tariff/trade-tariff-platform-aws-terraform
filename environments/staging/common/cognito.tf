...
<body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 20px; background-color: #f9f9f9;">
    <table style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; padding: 20px;">
        <tr>
            <td>
                <p style="color: #555555;">You have been invited to access <a href="https://tea.staging.trade-tariff.service.gov.uk/" style="color: #1a73e8;">Commodi-Tea</a>. Please use the following details to log in and set up your account:</p>
