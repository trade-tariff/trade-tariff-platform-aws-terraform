...
| <a name="input_project"></a> [project](#input\_project) | The name of the project | `string` | `"trade-tariff"` | no |
| <a name="input_s3_tags"></a> [s3\_tags](#input\_s3\_tags) | Tags | `map(string)` | n/a | yes |
